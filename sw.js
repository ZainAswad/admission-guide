...
const REV   = 'wz-3';                 /* ارفعه ليُمسح المخزون القديم عند الزوّار */
const CACHE = 'wz-' + REV;
/* العنوان النظيف لا الملف: cleanUrls يحوّل ‎/admin.html‎ إلى ‎/admin‎ بـ308،
   واستجابة مُحوَّلة لا تصلح للملاحة من المخزون */
const SHELL = ['/', '/admin'];
